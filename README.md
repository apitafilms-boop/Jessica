...
* Shizuku (Alternative-to-root app used to gain higher privledges)
...
* Silence (Control who calls)
* Wi-Fi Manager (Manage Wi-Fi connections)
...
* Smart Card Emulator (Emulates supported smart cards)
* Ton UINO NFC Tools (A collection of NFC tools)
* MIFARE Classic Tool (A collection of RFID tools
